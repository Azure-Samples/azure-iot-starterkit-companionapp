...
import { ActivityIndicator, Alert, View, Text, TextInput, TouchableOpacity } from 'react-native'
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.wifiConnectContainer}>
          ...
          {hasPassphrase && <Text style={styles.stepText}>
            1. Connect to the <Text style={styles.bold}>{accessPoint.ssid}</Text> network with the password <Text style={styles.bold}>{accessPoint.passphrase}</Text>. You will need to open Network and Internet Settings.
          </Text>}
          {!hasPassphrase && <Text style={styles.stepText}>
            1. Connect to the <Text style={styles.bold}>{accessPoint.ssid}</Text> network (no password required). You will need to open Network and Internet Settings.
          </Text>}
          ...
          <View style={styles.textInputGroup}>
            <Text style={styles.textInputLabel}>Network Password</Text>
            <PasswordInput inputValue={this.state.passphrase}
              onChangeText={this.onPasswordChange} disableShow={true} />
          </View>
        </View>
        <View>
